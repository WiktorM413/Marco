...
namespace Marco
{
	...
	private:
		...
		static TomlError HandleString       (TomlValue& currTomlValue, const std::string& tomlString, size_t& index);
		static TomlError HandleStringLiteral(TomlValue& currTomlValue, const std::string& tomlString, size_t& index);
